...
vim.keymap.set("n", "]]", function() vim.fn.search("^<\\(template\\|script\\|style\\)", "W") end, { buffer = true })
vim.keymap.set("n", "[[", function() vim.fn.search("^<\\(template\\|script\\|style\\)", "bW") end, { buffer = true })
